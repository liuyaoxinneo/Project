...
!metal
	 ...
	 !============================           
                    ...
                    vlbxf(m)=vxf(m,n)+K2/K1*(vyf(m,n)-vyf(m-1,n))
					 ...
					 t=k*deltt/2
                     Focus=sqrt((m-xxx)**2+yyy**2)*deltd            !焦距
...
!===========================================================================
                ...
                else if (((n>=180.and.n<=200).and.(m>=180.and.m<=200)).or.((n>=280.and.n<=200).and.(m>=180.and.m<=200))) then                  !破损区域
   ...
   if (1) then
      ...
      do sig_row=2,row-2
          ...
          !open(sig_row+101,file=adjustr(filename)//"y_rev.txt",position="rewind") 
           write(sig_row+100,"(1x,E15.7)") (v_recsig_x(sig_row,i),i=1,20000)
